...
- De acuerdo a todo lo visto en los párrafos anteriores, ¿qué tipo de actividad puede asociarse a la falla Reitfontein Fault? ¿Es una falla paleosísmica o neotéctonica?
...
- Structure: one section (##) per question. There are six questions.
- Presenta un resumen compacto de la respuesta a cada pregunta
