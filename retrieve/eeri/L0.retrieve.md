Nisar A, Doumbalski N, Mantchev E, Yen W. Seismic Assessment of Buried Prestressed Concrete Reservoir using Nonlinear Soil-Structure Interaction Analysis. Proceedings of the 13th National Conference in Earthquake Engineering, Earthquake Engineering Research Institute, Portland, OR. 2026.
...
¹ Principal Engineer, InfraTerra, Inc., San Francisco, CA (email: anisar@infraterra.com)
² Senior Engineer, InfraTerra, Inc., San Francisco, CA (email: ndoumbalski@infraterra.com)
³ Water Transmission Program Manager, Seattle Public Utilities, Seattle, WA (email: Eugene.Mantchev@seattle.gov)
⁴ Senior Staff Engineer, InfraTerra, Inc., San Francisco, CA 94103 (email: wyen@infraterra.com)
...
**(a) Top of the Fully Buried Reservoir** **(b) Reservoir Interior; Note People for Scale**

**Figure 2.** 30 MG Buried Prestressed Concrete Reservoir.

## Seismic Hazard

Geotechnical investigations show the site to be underlain by medium dense to very dense fill over glacial till. The glacial till is likely underlain by sandstone and siltstone but the borings do not show a consistent pattern throughout the site. The geophysical investigations show site Vs30 to range between 1,351 ft/s to 1,157 ft/s. The reservoir site is underlain by the Seattle Basin with the depth to basement rock over 7,000 meters. Ground motions considering basin effects and measured Vs30 were computed for eight earthquake cases including M9 and M7 on CSZ, M7 on SFZ and probabilistic ground motions for 72, 100, 475, 975, and 2,475-year return periods. For nonlinear SSI analysis acceleration time histories were selected by developing the conditional mean spectrum as described in Baker and Cornell [@BakerCornell2006] and Baker [@Baker2011].

**(a) Birdseye View During Construction** **(b) Seismic Cables at Wall Base**

**Figure 3.** Reservoir under Construction.

**(a) Wall to Roof Connection Construction Photograph** **(b) Movement at Shear Keys**

**Figure 4.** Shear Keys at Roof to Wall Connection.

## Soil-Structure Interaction Analysis

SSI analysis was performed using LS-Dyna with the schematic of the model shown in Figure 5.

**(a) Schematic of SSI Analysis Approach** **(b) SSI Finite Element Model**

**Figure 5.** SSI Analysis Approach and Finite Element Model.

The reservoir wall, base slab, and roof slab was modeled with shell elements and interior columns with beam elements. Elastic material model for concrete was used because no significant material nonlinearity is expected due to the existing prestressing. Contact elements to allow for uncoupled behavior between the roof and the wall and between the wall and the foundations were used. Mass of the water inside the reservoir was modeled as impulsive and convective components per ACI 350.3-06 [@ACI350.3-06]. The impulsive mass was rigidly attached to the reservoir wall. Force associated with the convective mass was applied as a static load in the direction of maximum response; a reasonable assumption because of the very long calculated sloshing period.
...
**a) Reservoir Deformation at Base** **b) Time History of Displacement**

**Figure 6.** Relative Displacement between Foundation and Floor Slab.
